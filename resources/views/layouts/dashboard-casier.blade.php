            ...
            <div class="d-flex" id="wrapper" data-aos="fade-right">
                ...
                <div class="border-right" id="sidebar-wrapper">
                    ...
                    <div class="list-group list-group-flush">
                        <a
                            href="{{ route('casier-dashboard') }}"
                            class="list-group-item list-group-item-action {{ request()->is('casier') ? 'active' : '' }}"
                        >
                            Dashboard
                        </a>
                        <a
                            href="{{ route('transactions.index') }}"
                            class="list-group-item list-group-item-action {{ request()->is('casier/transactions*') ? 'active' : '' }}"
                            >
                            Transactions
                        </a>
